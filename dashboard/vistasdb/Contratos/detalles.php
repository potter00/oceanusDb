...
if (!isset($_GET['edit'])) {
    ...
    <p><Strong>Tipo de contrato: </Strong>
        <select name="tipo_contrato" id="contratoTipoContrato" value="<?php echo $contratoSeleccionado['subContrato'] ?>">
            <option value="Contrato Origen">Origen</option>
            <option value="subComtrato">SubContrato</option>
        </select>
    </p>
    ...
    <p><strong>Aseguradora</strong><input id="contratoFianzaCumplimientoAseguradora"
            value="<?php echo $datosFianzas["fianzaCumplimiento"]['fianzaCumplimientoAseguradora'] ?>" type="text"></p>
    <hr>
    ...
    <p><strong>Aseguradora</strong><input id="contratoFianzaViciosOcultosAseguradora"
            value="<?php echo $datosFianzas["fianzaViciosOcultos"]['fianzaViciosOcultosAseguradora'] ?>" type="text"></p>
